...
import LightingModel from '/assets/js/core/LightingModel.js';
import { diffuseColor, specularColor, roughness, clearcoat, clearcoatRoughness, sheen, sheenRoughness, iridescence, iridescenceIOR, iridescenceThickness } from '/assets/js/core/PropertyNode.js';
import { transformedNormalView, transformedClearcoatNormalView } from '/assets/js/accessors/NormalNode.js';
import { positionViewDirection } from '/assets/js/accessors/PositionNode.js';
import { tslFn, float, vec3, mat3 } from '/assets/js/shadernode/ShaderNode.js';
import { cond } from '/assets/js/math/CondNode.js';
