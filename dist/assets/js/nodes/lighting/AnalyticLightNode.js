...
import { NodeUpdateType } from '/assets/js/core/constants.js';
import { uniform } from '/assets/js/core/UniformNode.js';
import { addNodeClass } from '/assets/js/core/Node.js';
import { /*vec2,*/ vec3, vec4 } from '/assets/js/shadernode/ShaderNode.js';
import { reference } from '/assets/js/accessors/ReferenceNode.js';
import { texture } from '/assets/js/accessors/TextureNode.js';
import { positionWorld } from '/assets/js/accessors/PositionNode.js';
import { normalWorld } from '/assets/js/accessors/NormalNode.js';
import { WebGPUCoordinateSystem } from '/assets/js/three.module.js';
//import { add } from '/assets/js/math/OperatorNode.js';

import { Color, DepthTexture, NearestFilter, LessCompare } from '/assets/js/three.module.js';
