...
import { cache } from '/assets/js/core/CacheNode.js';
import { context } from '/assets/js/core/ContextNode.js';
import { maxMipLevel } from '/assets/js/utils/MaxMipLevelNode.js';
import { roughness, clearcoatRoughness } from '/assets/js/core/PropertyNode.js';
import { equirectUV } from '/assets/js/utils/EquirectUVNode.js';
import { specularMIPLevel } from '/assets/js/utils/SpecularMIPLevelNode.js';
import { cameraViewMatrix } from '/assets/js/accessors/CameraNode.js';
import { transformedClearcoatNormalView, transformedNormalView, transformedNormalWorld } from '/assets/js/accessors/NormalNode.js';
...
import { reference } from '/assets/js/accessors/ReferenceNode.js';
