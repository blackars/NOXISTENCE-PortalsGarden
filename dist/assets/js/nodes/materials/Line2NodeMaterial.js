...
import { temp } from '/assets/js/core/VarNode.js';
import { varying } from '/assets/js/core/VaryingNode.js';
import { property, varyingProperty } from '/assets/js/core/PropertyNode.js';
import { attribute } from '/assets/js/core/AttributeNode.js';
import { cameraProjectionMatrix } from '/assets/js/accessors/CameraNode.js';
import { materialColor, materialLineScale, materialLineDashSize, materialLineGapSize, materialLineDashOffset, materialLineWidth } from '/assets/js/accessors/MaterialNode.js';
import { modelViewMatrix } from '/assets/js/accessors/ModelNode.js';
import { positionGeometry } from '/assets/js/accessors/PositionNode.js';
import { mix, smoothstep } from '/assets/js/math/MathNode.js';
import { tslFn, float, vec2, vec3, vec4, If } from '/assets/js/shadernode/ShaderNode.js';
import { uv } from '/assets/js/accessors/UVNode.js';
import { viewport } from '/assets/js/display/ViewportNode.js';
import { dashSize, gapSize } from '/assets/js/core/PropertyNode.js';

import { LineDashedMaterial } from '/assets/js/three.module.js';
